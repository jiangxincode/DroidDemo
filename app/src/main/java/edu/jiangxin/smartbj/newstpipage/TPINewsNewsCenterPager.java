package edu.jiangxin.smartbj.newstpipage;
...
import edu.jiangxin.smartbj.activity.NewsDetailAcitivity;
import edu.jiangxin.smartbj.domain.NewsCenterData.NewsData.ViewTagData;
import edu.jiangxin.smartbj.domain.TPINewsData;
import edu.jiangxin.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_ListNewsData;
import edu.jiangxin.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_LunBoData;
import edu.jiangxin.smartbj.utils.DensityUtil;
import edu.jiangxin.smartbj.utils.MyConstants;
import edu.jiangxin.smartbj.utils.SpTools;
import edu.jiangxin.smartbj.view.RefreshListView.OnRefreshDataListener;
...
public class TPINewsNewsCenterPager
{
	...
	private edu.jiangxin.smartbj.view.RefreshListView lv_listnews;// 显示列表新闻的组件
	...
	private void initData() {
		...
		if (!TextUtils.isEmpty(jsonCache)) {
			//有数据，解析数据
			edu.jiangxin.smartbj.domain.TPINewsData newsData = parseJson(jsonCache);
			//处理数据
	 ...
	 * @param newsData
	 */
	private void processData(edu.jiangxin.smartbj.domain.TPINewsData newsData){
		//完成数据的处理
	...
	private void setListViewNews(
			edu.jiangxin.smartbj.domain.TPINewsData newsData) {
	...
	private void setLunBoData(edu.jiangxin.smartbj.domain.TPINewsData newsData) {
		//获取轮播图的数据
	...
	private void getDataFromNet(final String url,final boolean isLoadingMore) {
		...
		httpUtils.send(HttpMethod.GET,  url, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				//解析数据
				edu.jiangxin.smartbj.domain.TPINewsData newsData = parseJson(jsonData);
