...
public class PbMoveTaskToBackCallbackActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        super.onDestroy();
        if ("Baklava".equals(Build.VERSION.CODENAME)) {
            getOnBackInvokedDispatcher().unregisterOnBackInvokedCallback(SystemOnBackInvokedCallbacks.moveTaskToBackCallback(this));
        }
    }
