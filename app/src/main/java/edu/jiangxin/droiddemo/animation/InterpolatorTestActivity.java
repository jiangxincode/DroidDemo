...
public class InterpolatorTestActivity extends Activity implements AdapterView.OnItemSelectedListener, MyAccelerateInterpolator.onInterpolationChangeListener {
    ...
    private RelativeLayout mTestInterpolator;
    private View target;
...
//        animation.setRepeatCount(-1);
        ...
        switch (position) {
            case 0:
                ...
                objectAnimator = ObjectAnimator.ofFloat(target, "translationY", engY);
                ...
                objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        distance_time.setText("动画时间：" + objectAnimator.getCurrentPlayTime());
                        distance_y_percent.setText("距离百分比：" + (target.getY() - startY) / engY);
                        distance_time_percent.setText("时间百分比：" + ((float) objectAnimator.getCurrentPlayTime() / (float) objectAnimator.getDuration()));
                    }
                });
                ...
                objectAnimator.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        distance_time.setText("动画时间：" + objectAnimator.getDuration());
