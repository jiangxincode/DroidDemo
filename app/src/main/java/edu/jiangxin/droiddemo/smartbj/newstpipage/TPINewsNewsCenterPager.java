package edu.jiangxin.droiddemo.smartbj.newstpipage;
...
import edu.jiangxin.droiddemo.smartbj.activity.NewsDetailAcitivity;
import edu.jiangxin.droiddemo.smartbj.domain.NewsCenterData;
import edu.jiangxin.droiddemo.smartbj.domain.TPINewsData;
import edu.jiangxin.droiddemo.smartbj.utils.DensityUtil;
import edu.jiangxin.droiddemo.smartbj.utils.MyConstants;
import edu.jiangxin.droiddemo.smartbj.utils.SpTools;
import edu.jiangxin.droiddemo.smartbj.view.RefreshListView;
...
public class TPINewsNewsCenterPager
{
	...
	//轮播图的数据
	private List<edu.jiangxin.droiddemo.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_LunBoData>	lunboDatas = new ArrayList<TPINewsData.TPINewsData_Data.TPINewsData_Data_LunBoData>();
    ...
    //新闻列表的数据
	private List<edu.jiangxin.droiddemo.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_ListNewsData>	listNews = new ArrayList<TPINewsData.TPINewsData_Data.TPINewsData_Data_ListNewsData>();
	...
	private void initEvent() {
		...
		lv_listnews.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				//获取点击当前新闻的链接
				edu.jiangxin.droiddemo.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_ListNewsData tpiNewsData_Data_ListNewsData = listNews.get(position - 1);
	...
	private void initData() {
		...
		if (!TextUtils.isEmpty(jsonCache)) {
			//有数据，解析数据
			edu.jiangxin.droiddemo.smartbj.domain.TPINewsData newsData = parseJson(jsonCache);
			//处理数据
	 ...
	 * @param newsData
	 */
	private void processData(edu.jiangxin.droiddemo.smartbj.domain.TPINewsData newsData){
		//完成数据的处理
	...
	private void setListViewNews(
			edu.jiangxin.droiddemo.smartbj.domain.TPINewsData newsData) {
	...
	private void setLunBoData(edu.jiangxin.droiddemo.smartbj.domain.TPINewsData newsData) {
		//获取轮播图的数据
	...
	private class ListNewsAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			edu.jiangxin.droiddemo.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_ListNewsData tpiNewsData_Data_ListNewsData = listNews.get(position);
	...
	private class LunBoAdapter extends PagerAdapter{
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			//给图片添加数据
			edu.jiangxin.droiddemo.smartbj.domain.TPINewsData.TPINewsData_Data.TPINewsData_Data_LunBoData tpiNewsData_Data_LunBoData = lunboDatas.get(position);
	...
	private void getDataFromNet(final String url,final boolean isLoadingMore) {
		...
		httpUtils.send(HttpMethod.GET,  url, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				//解析数据
				edu.jiangxin.droiddemo.smartbj.domain.TPINewsData newsData = parseJson(jsonData);
