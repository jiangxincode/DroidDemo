...
import edu.jiangxin.droiddemo.smartbj.domain.PhotosData;
import edu.jiangxin.droiddemo.smartbj.utils.BitmapCacheUtils;
...
public class PhotosBaseNewsCenterPage extends BaseNewsCenterPage {
    ...
    private List<PhotosData.PhotosData_Data.PhotosNews> photosNews = new ArrayList<PhotosData.PhotosData_Data.PhotosNews>();
