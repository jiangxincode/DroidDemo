...
import com.itheima.easychat.service.IMService;
        ...
        ThreadUtils.runInThread(new Runnable() {
            ...
            public void run() {
                final Cursor c = getContentResolver().query(SmsProvider.URI_SMS,//
                        ...
                        new String[]{IMService.mCurAccout.asEntityBareJidString(), mClickAccount, mClickAccount, IMService.mCurAccout.asEntityBareJidString()},// where条件的参数
