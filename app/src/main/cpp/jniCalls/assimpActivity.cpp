...
Java_edu_jiangxin_droiddemo_opengl_assimp_AssimpActivity_CreateObjectNative(JNIEnv *env,
                                                                         jobject instance,
...
JNIEXPORT void JNICALL
Java_edu_jiangxin_droiddemo_opengl_assimp_AssimpActivity_DeleteObjectNative(JNIEnv *env,
                                                                         jobject instance) {
