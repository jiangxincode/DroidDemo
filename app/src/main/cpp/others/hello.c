 ...
 *	(*env)->NewStringUTF();
 */
jstring Java_edu_jiangxin_droiddemo_activity_JNIActivity_helloFromC(JNIEnv *env, jobject obj){
...
jint Java_edu_jiangxin_droiddemo_activity_JNIActivity_resultFromC(JNIEnv *env,
